...
class Routes(
  ...
  // @LINE:6
  InteressadoCRUD_2: controllers.InteressadoCRUD,
  // @LINE:8
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:16
    Assets_0: controllers.Assets
  ) = this(errorHandler, InteressadoCRUD_2, CountController_3, AsyncController_1, Assets_0, "/")

  import ReverseRouteContext.empty

  def withPrefix(prefix: String): Routes = {
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, InteressadoCRUD_2, CountController_3, AsyncController_1, Assets_0, prefix)
  }
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_InteressadoCRUD_index0_route(params) =>
      call { 
        controllers_InteressadoCRUD_index0_invoker.call(InteressadoCRUD_2.index)
      }
    ...
    case controllers_InteressadoCRUD_add2_route(params) =>
      call { 
        controllers_InteressadoCRUD_add2_invoker.call(InteressadoCRUD_2.add)
      }
  
    // @LINE:13
    case controllers_AsyncController_message3_route(params) =>
      call { 
        controllers_AsyncController_message3_invoker.call(AsyncController_1.message)
      }
